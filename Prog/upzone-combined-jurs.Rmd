...
clarendon <- filter(nodes_varies, name == "Rosslyn", node == "Transit")
...
x <- readRDS("L:/Libraries/RegHsg/Data/arlington/precleaned-arlington-data.Rdata")

x1 <- x %>% 
  filter(str_detect(propaddress, "S HAYES ST") == TRUE)
