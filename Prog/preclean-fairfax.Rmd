...
There are `r (!jur_temp$parcel_id%in%land_temp$parcel_id) %>% sum` units in the Blacknight data that are not in the land data. 
There are `r (!land_temp$parcel_id%in%jur_temp$parcel_id) %>% sum` units in the land data that are not in the Blacknight data.  
