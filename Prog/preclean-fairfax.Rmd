...
There are `r (!tax_final$parcel_id%in%jur_temp$parcel_id) %>% sum` units in the combined tax data that are not in the BlackKnight data.  
There are `r (!jur_temp$parcel_id%in% tax_final$parcel_id) %>% sum` units in the BlackKnight data that are not in the tax data.
