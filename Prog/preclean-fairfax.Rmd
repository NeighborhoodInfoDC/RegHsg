...
jdir <- paste0("D:/Users/cdavis/Documents/RegHsg/Data", filepath, "/")
rdir <- paste0("D:/Users/cdavis/Documents/RegHsg/Raw", filepath, "/")
...
if (!dir.exists(paste0("D:/Users/cdavis/Documents/RegHsg/Raw", filepath))) {
  dir.create(paste0("D:/Users/cdavis/Documents/RegHsg/Raw", filepath))
}
...
parcel<-parcel %>% 
  group_by(parcel_id) %>%
  summarize(loc_desc=first(loc_desc),
  luc_desc=first(luc_desc),
  zone = first(zone))
```
...
dwelling<-dwelling %>% 
  group_by(parcel_id) %>%
  summarize(stories=first(stories),
  possibleSF = first(possibleSF))
```
