...
Go back to parcel file and fix coordinates.
```{r read-parcel}
...
download.file("https://opendata.arcgis.com/datasets/b70198178ff44462b00c5b5c0012668d_0.zip?outSR=%7B%22wkid%22%3A102746%2C%22latestWkid%22%3A2283%7D", destfile = pzip)

unzip(pzip, exdir = pdir)

pfile <- str_sub(list.files(pdir), end = -5) %>% unique()

parcel_sf <- read_sf(dsn = pdir,
                     layer = pfile)
