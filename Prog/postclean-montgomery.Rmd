...
outputdata <- pjoin_df1 %>%
select(outputdata, OBJECTID, propaddress, propcity, assessorsparcelnumberapnpin, countylandusedescription, LANDUSE_CO ,LU_CATEGOR, category, category_detail, residential, building_type,lotsize_sf, SHAPE_AREA, IMPROV_ASS, NO_DWELLIN, DWELLING_T)
