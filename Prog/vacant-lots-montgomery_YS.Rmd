...
Read in zoning code, rename variables so that they are machine readable. Again, rockville and Gaithersburg zoing information is in the same document with Montgomery, we are reading in the whole file and filtering out zoning by jurisdiction. 
...
get_unit_variables_g <- function(dataset, 
  ...
  dataset %>% 
    ...
    mutate( units_total = ifelse(is.na(units_total)==0 |units_total > (density *(lotsize_sf/43560)), floor(density *(lotsize_sf/43560)),units_total))
