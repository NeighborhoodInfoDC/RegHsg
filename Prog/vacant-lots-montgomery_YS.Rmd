...
```{r read}
if (!exists("jur")) {
  jur <-  read_csv (paste0("L:/Libraries/RegHsg/Data/", "montgomery",
                     "/", "postcleaned-", "montgomery", "-data.csv"),
               col_types = cols(
...
get_unit_variables_r <- function(dataset, 
  ...
  dataset %>% 
    mutate(parameters = paste0("CE: ", construction_efficiency * 100,
           ...
           lot_coverage_max= ifelse(is.na(lot_coverage_max)==1, 0.0075, lot_coverage_max),
           buildable_area = lotsize_sf * lot_coverage_max*100,
