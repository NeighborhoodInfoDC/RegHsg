...
z <- cols(
  ...
  site_area_min = col_number(),
  sitearea_per_unit = col_number(),
  lot_area_min = col_number(),
  lotarea_per_unit = col_number(),
  lot_width = col_character(),
  lot_width_building = col_character(),
  height_ft = col_double(),
  site_coverage_max = col_number(),
  lot_coverage_max = col_number(),
...
zoning_rockville <- zoning_rockville %>% 
...
# fix variables read in as whole numbers (should be percent)
zoning_gaithersburg <- zoning_gaithersburg %>% 
  mutate_at(vars(lot_coverage_max, site_coverage_max, open_space),
            ~ . / 100)
rm(z)
