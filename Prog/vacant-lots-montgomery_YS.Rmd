...
vacant_rockvile2 <- anti_join(vacant_rockvile1, zoning_rockville1, by = c("zoning_code")) 


issuelotrockville<- vacant_rockvile2 %>% 
  filter(zoning_code=="RNC") %>% 
...
zoningdata_rockvile2 <- left_join(vacant_rockvile2, zoning_montgomery1, by = "zoning_code")
...
zoningdata_rockvile3 <- left_join(vacant_rockvile1, zoning_rockville1, by = "zoning_code")
