...
nested <- multiples_1 %>% 
  ...
  summarize_at(vars(zoning,lotsize_sf,
                    ...
                    yearbuilt, long, lat,
                    area_tax, zone_tax, possibleSF_tax, stories_tax, units_tax, category_tax, land_per_parcel, dwellings_per_parcel, num_livunit), list) %>% 
...
singles_f <- singles_1 %>% 
  select(county_fips, county_name,
         ...
         ends_with("prop"),
         area_tax, zone_tax, possibleSF_tax, stories_tax, category_tax,               units_tax, parcel_id, num_livunit, dwellings_per_parcel, land_per_parcel)
