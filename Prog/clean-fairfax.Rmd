...
Test different lot size variables.
...
area_testing %>% 
  ...
  summarize(same_area = sum(lotsize_sf == area_tax),
            ...
            difference_over_500 = sum(difference > 500),
            difference_over_1000 = sum(difference > 1000)) %>% 
  knitr::kable()

```
Most of the differences between `area_tax` and `lotsize_sf` are small.
