...
zoningcode1 <- zoningcode %>% 
  mutate(newdwelling_type = case_when(
    ...
    dwelling_units_allowed==2 ~ "RF2",
    dwelling_units_allowed==3 ~ "RF3",
    dwelling_units_allowed==4 ~ "RF4",
...
get_unit_variables <- function(dataset, 
  ...
  dataset %>% 
    mutate(parameters = paste0("CE: ", construction_efficiency * 100,
          ...
          #lotarea_per_unit is missing for all in DC, so use units_height for units estimates
