...
anti_join(vacantcleaned, zoningcode1, by = c("zoning_code")) %>% 
  count(zoning_code) %>% 
  knitr::kable()
...
anti_join(vacantcleaned2, zoningcode1, by = c("zoning_code")) %>% 
  filter(zoning_code=="R1") %>% 
  count(zoning_code) %>% 
  knitr::kable()

zoningdatanew2 <- left_join(vacantcleaned2, zoningcode1, by = "zoning_code")
