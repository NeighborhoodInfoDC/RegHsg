...
After the join, we convert back to a dataframe and recombine the two vacant datasets together.
...
nrow(jurzoningdata1)
 ...
 ggplot(jurzoningdata1, aes(lotsize_sf) )+
   geom_histogram(binwidth = 5000)
# 
# 
# ggplot(jurzoningdata1, aes(lot_area_min) )+
#   geom_histogram(binwidth = 500)
# 
# 
# ggplot(jurzoningdata1, aes(gap ))+
#   geom_histogram(binwidth = 500)
