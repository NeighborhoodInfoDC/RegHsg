...
get_unit_variables(dataset = vacantlotunits,
                 construction_efficiency = .7,
                 average_unit_size = 940) %>% 
  select(parameters, parcelbase_SSL, parcelbase_usecode,lotsize_sf, lotsize_sf, buildable_area, living_area, height_ft, floors, FAR_stories,             units_per_floor, units_min, units_FAR, units_height, propaddress, zoning_code, one_unit_flag, two_unit_flag, subset ) %>% 
