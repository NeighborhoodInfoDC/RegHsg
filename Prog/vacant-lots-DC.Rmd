...
jurjoin3_parks <- st_join(jurzoningdata3_parcel, DCparks, join = st_intersects)
...
jurjoin3_nationalparks <- st_join(jurzoningdata3_parcel, nationalpark, join = st_intersects)
