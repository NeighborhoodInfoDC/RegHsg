...
Create buffer around the stations. To do this, we re-project to feet, create the buffer, then re-project back to CRS = 4326. Note that the buffer for the train stations is half a mile, as opposed to a mile for the activity centers.
...
Create buffer around activity centers. Note that the buffer for activity centers is 1 mile.
...
actvity_buffered <- get_node_geography(node_type = "activity",
                                       style = "buffer",
                                       activity_buffer = 1)
