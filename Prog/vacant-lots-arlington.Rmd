...
Priotize codes that are purely residential (begin with R). If there are more than 1 "R" zoning codes, we want to take the one with the higher number. 
