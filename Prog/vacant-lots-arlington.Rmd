...
paste0(sum(is.na(vacant1$ZN_DESIG)), " observations didn't join- ",
      round(sum(is.na(vacant1$ZN_DESIG)) / nrow(vacant1) * 100, 2), "%")

if (sum(is.na(vacant1$ZN_DESIG)) / nrow(vacant1) > .05) {
