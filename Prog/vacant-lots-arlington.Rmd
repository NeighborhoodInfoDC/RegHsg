...
Save the final vacant lots data so it can be used for the special exceptions (this is only required for Arlington county).

```{r save-vacant}

# saveRDS(vacantfinal, "L:/Libraries/RegHsg/Data/arlington/arlington-vacant-lots.Rdata")
...
saveRDS(units,
        "L:/Libraries/RegHsg/Data/arlington/arlington-max-density.Rdata")
