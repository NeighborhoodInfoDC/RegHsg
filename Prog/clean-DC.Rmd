...
jur %>% 
 filter(countylandusedescription == "FALSE VACANT") %>% 
  select(assessorsparcelnumberapnpin, parcelbase_address, owneroccupiedresidential,  parcelbase_phasebuild) %>% 
...
nested <- allmultiple2 %>% 
  ...
  summarize_at(vars(zoning,lotsize_sf,
                    ...
                    parcelbase_phasebuild, parcelbase_phaseland, parcelbase_mix1txtype), list) %>% 
...
singles_f <- allsingle2 %>% 
  select(county_fips, county_name,
         ...
         assessedlandvalue, assessedimprovementvalue, totalassessedvalue,
         parcelbase_phasebuild, parcelbase_phaseland, parcelbase_mix1txtype)
