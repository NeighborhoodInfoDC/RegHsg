...
rm(length)   
  ...
  summarize_at(vars(zoning,lotsize_sf,
                    ...
                    yearbuilt, parcelgeo_x, parcelgeo_y, assessedlandvalue, assessedimprovementvalue, totalassessedvalue), list) %>% 
...
singles_f <- singles %>% 
  select(county_fips, county_name,
         ...
         parcelbase_address, parcelbase_usecode, parcelgeo_x, parcelgeo_y, assessedlandvalue, assessedimprovementvalue, totalassessedvalue)
