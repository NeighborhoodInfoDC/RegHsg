...
#since duplicate is introduced because of removing "BD", "PI", "WF", need to remove one record
...
#of the 20112 observations from black knight didn't merge,   are in the parcelbase dataset but was not in the most recent update 
