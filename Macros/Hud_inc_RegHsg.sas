    ...
    select ( &hhsize. );
      when ( 1 )
        do;
          ...
          else if 38050 < &hhinc. <= 60933 then hud_inc = 3;
          else if 60933 < &hhinc. <= 91400 then hud_inc = 4;
          else if 91400 < &hhinc. <= 152333 then hud_inc = 5;
		  else if 152333 <&hhinc.  then hudinc=6;
        end;
      when ( 2 )
        do;
          ...
          else if 104280 < &hhinc. <= 174000 then hud_inc = 5;
		  else if 174000 < &hhinc. then hudinc=6;
        end;
      when ( 3 )
        do;
          ...
          else if 117360 < &hhinc. <= 195667 then hud_inc = 5;
          else if 195667 < &hhinc. then hudinc=6;
        end;
      when ( 4 )
        do;
          ...
          else if 130320 < &hhinc. <= 217333 then hud_inc = 5;
		  else if 217333 < &hhinc. then hudinc=6;
        end;
      when ( 5 )
        do;
          ...
          else if 140760 < &hhinc. <= 235000 then hud_inc = 5;
		  else if 235000 < &hhinc. then hudinc=6;
        end;
      when ( 6 )
        do;
          ...
          else if 151200 < &hhinc. <= 252333 then hud_inc = 5;
		  else if 252333 < &hhinc. then hudinc=6;
        end;
      when ( 7 )
        do;
          ...
          else if 161640 < &hhinc. <= 269667 then hud_inc = 5;    
          else if 269667 < &hhinc. then hud_inc = 6;
        end;
      otherwise
        do;
          ...
          else if 172080 < &hhinc. <= 287000 then hud_inc = 5;
          else if 287000 < &hhinc. then hud_inc = 6;
        end;
    end;
